...
module.exports = class extends Component {
    render() {
        ...
        return <Fragment>
            ...
            <script src={mycdn('js/column.js')}></script>
            <Plugins site={site} config={config} page={page} helper={helper} head={false} />
            <script src={mycdn('js/main.js')} defer></script>
            <script src={mycdn('js/title.js')}></script>
            <script src={mycdn('js/universe.js')}></script>
        </Fragment>;
    }
};
