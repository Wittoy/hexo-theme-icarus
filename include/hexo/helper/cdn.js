...
const PROVIDERS = {
    LIBRARY: {
        ...
        baomitu: '[cdnjs]https://lib.baomitu.com/${ package }/${ version }/${ filename }',
    ...
    ICON: {
        jsdelivr: 'https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.13.0/css/all.min.css',
        ...
        aliyun: '//at.alicdn.com/t/font_1664716_qg3iuewi24l.css'
    },
    CUSTOM: {
        jsdelivr: 'https://cdn.jsdelivr.net/gh/Wittoy/cdn@latest/icarus/${ cdnname }',
        local: '/${ cdnname }'
    } 
};
...
module.exports = function(hexo) {
    ...
    hexo.extend.helper.register('iconcdn', function() {
        let { iconcdn = 'jsdelivr' } = typeof this.config.providers === 'object' ? this.config.providers : {};
    ...
    hexo.extend.helper.register('mycdn', function(CdnName) {
        let { mycdn = 'jsdelivr' } = typeof this.config.providers === 'object' ? this.config.providers : {};
        if (mycdn in PROVIDERS.CUSTOM) {
            mycdn = PROVIDERS.CUSTOM[mycdn];
        }
        return mycdn.replace(/\${\s*cdnname\s*}/gi, CdnName);
    });
};